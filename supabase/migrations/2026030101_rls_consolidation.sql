...
-- daily_attendance, bucket_records, and harvest_settings.
...
-- =============================================
-- SKIPPED (broadcasts table does not exist): DROP POLICY IF EXISTS "broadcasts_view_policy" ON broadcasts;
-- SKIPPED (broadcasts table does not exist): CREATE POLICY "broadcasts_view_policy" ON broadcasts FOR
-- SELECT USING (auth.uid() IS NOT NULL);
-- SKIPPED (broadcasts table does not exist): DROP POLICY IF EXISTS "broadcasts_insert_policy" ON broadcasts;
-- SKIPPED (broadcasts table does not exist): CREATE POLICY "broadcasts_insert_policy" ON broadcasts FOR
-- INSERT WITH CHECK (is_manager());
-- SKIPPED (broadcasts table does not exist): DROP POLICY IF EXISTS "broadcasts_update_policy" ON broadcasts;
-- SKIPPED (broadcasts table does not exist): CREATE POLICY "broadcasts_update_policy" ON broadcasts FOR
-- UPDATE USING (is_manager());
-- SKIPPED (broadcasts table does not exist): DROP POLICY IF EXISTS "broadcasts_delete_policy" ON broadcasts;
-- SKIPPED (broadcasts table does not exist): CREATE POLICY "broadcasts_delete_policy" ON broadcasts FOR DELETE USING (is_manager());
-- =============================================
