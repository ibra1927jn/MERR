                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2.5 rounded-xl border border-border-light text-text-primary font-medium focus:border-orange-500 focus:ring-2 focus:ring-orange-500/10 outline-none"
                        />
                    </div>
                    <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
                ...
                <button
                    ...
                    className="bg-white rounded-xl p-4 shadow-sm border border-border-light flex items-center gap-3 hover:shadow-md transition-shadow text-left disabled:opacity-40 disabled:cursor-not-allowed"
                >
