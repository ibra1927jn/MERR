...
-- 2. RLS Policies para Inmutabilidad de bucket_records
...
DROP POLICY IF EXISTS "no_update_on_closed_days" ON bucket_records;
...
DROP POLICY IF EXISTS "no_delete_on_closed_days" ON bucket_records;
