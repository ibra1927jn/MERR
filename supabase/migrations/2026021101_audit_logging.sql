...
-- =============================================
-- 2. CREATE INDEX IF NOT EXISTSES FOR PERFORMANCE
-- =============================================
...
DROP TRIGGER IF EXISTS audit_settings ON harvest_settings;
CREATE TRIGGER audit_settings
AFTER
UPDATE ON harvest_settings FOR EACH ROW EXECUTE FUNCTION log_audit_trail();
...
RAISE NOTICE 'Triggers created for: pickers, harvest_settings, users, daily_attendance, orchards';
