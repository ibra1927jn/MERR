...
const leader = { id: 'l1', name: 'John Leader', total_buckets_today: 25, role: 'team_leader' } as any;
const members = [
...
describe('RowTeamDisplay', () => {
    ...
    it('renders team header when teams exist', () => {
        render(<RowTeamDisplay teamsOnRow={[{ leader, members, total: 3 }]} totalPeople={3} rowNumber={7} />);
