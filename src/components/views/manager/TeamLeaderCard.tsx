...
const TeamLeaderCard: React.FC<TeamLeaderCardProps> = ({ leader, crew, onSelectUser, settings }) => {
    ...
    return (
        <div className="glass-card overflow-hidden transition-all hover:border-gray-300">
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    <h3 className="text-lg font-black text-gray-900 truncate">{leader.name}</h3>
                ...
                <div className="flex flex-col items-end gap-1">
                    <span className="text-2xl font-black text-gray-900">{totalBuckets}</span>
            ...
            <div className={`border-t border-gray-100 bg-gray-50/50 overflow-hidden transition-all duration-300 ease-in-out ${isExpanded ? 'max-h-[5000px] opacity-100' : 'max-h-0 opacity-0'}`}>
                <div className="p-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    >
                        ...
                        <div className="flex-1">
                            <p className="font-bold text-gray-900 text-sm">{leader.name} (Lead)</p>
                    ...
                    {crew.map(member => {
                        ...
                        return (
                            <div
                                ...
                                className={`flex items-center gap-3 p-3 bg-white rounded-xl border cursor-pointer transition-colors group relative overflow-hidden ${isLowPerf ? 'border-red-500/30 hover:border-red-500' : 'border-gray-200 hover:border-primary/50'}`}
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex justify-between items-center mt-0.5">
                                        ...
                                        <span className={`text-xs font-black ${isLowPerf ? 'text-red-500' : 'text-gray-600'}`}>
