    ...
    return (
        <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto pb-24 animate-fade-in">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <DashboardStatCard title="Velocity" value={animVelocity} unit="b/hr" icon="speed" iconBg="bg-blue-50" iconColor="text-blue-600" onClick={() => setActiveTab('map')} staggerIndex={0} />
                <DashboardStatCard title="Production" value={animBuckets} unit="buckets" trend={productionTrend} icon="inventory_2" iconBg="bg-indigo-50" iconColor="text-indigo-600" onClick={() => setActiveTab('logistics')} staggerIndex={1} />
                <DashboardStatCard title="Est. Cost" value={`$${animCost.toLocaleString(undefined, { maximumFractionDigits: 0 })}`} unit="NZD" icon="payments" iconBg="bg-green-50" iconColor="text-green-600" onClick={() => setActiveTab('analytics')} staggerIndex={2} />
                <DashboardStatCard title="Active Crew" value={animCrew} unit="pickers" icon="groups" iconBg="bg-purple-50" iconColor="text-purple-600" onClick={() => setActiveTab('teams')} staggerIndex={3} />
            </div>
