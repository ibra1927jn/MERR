...
describe('SeasonalPlanningTab', () => {
    ...
    it('renders workforce planning sections with employees', async () => {
        ...
        const SeasonalPlanningTab = mod.default;
        const employees = [
            { id: 'e1', name: 'Alice', status: 'active', contract_end: '2026-04-15', role: 'picker', visa_type: 'RSE' },
            { id: 'e2', name: 'Bob', status: 'active', contract_end: '2026-03-20', role: 'picker', visa_type: 'WH' },
        ];
...
describe('FleetTab', () => {
    ...
    it('renders tractor cards', async () => {
        ...
        const FleetTab = mod.default;
        const tractors = [{
            id: 't1', name: 'Tractor Alpha', driver_name: 'Driver A',
            zone: 'A1', status: 'active', bins_loaded: 5, max_capacity: 20,
            load_status: 'partial', last_update: '2026-03-09T10:00:00Z',
        }];
    ...
    it('zone map highlights active zones', async () => {
        ...
        const FleetTab = mod.default;
        const tractors = [{
            id: 't1', name: 'T1', driver_name: 'D', zone: 'A1', status: 'active',
            bins_loaded: 0, max_capacity: 20, load_status: 'empty', last_update: '2026-03-09T10:00:00Z',
        }];
...
describe('Team Leader Views — module exports', () => {
    it('AttendanceView exports', () => testModuleExport('@/components/views/team-leader/AttendanceView'));
    ...
    it('LogisticsView exports', () => testModuleExport('@/components/views/team-leader/LogisticsView'));
    it('MessagingView exports', () => testModuleExport('@/components/views/team-leader/MessagingView'));
...
describe('Logistics SubViews — module exports', () => {
    ...
    it('BinTrackingTab exports', () => testModuleExport('@/components/views/logistics/BinTrackingTab'));
});
