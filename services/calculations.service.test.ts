...
describe('calculationsService', () => {
    describe('calculatePickerStatus', () => {
        ...
        it('should return green when earnings are 10% above minimum wage', () => {
            // At $6.50/bucket and $23.50 min wage, need ~4 buckets/hour for minimum
            // 10% above = ~4.4 buckets/hour or earnings of $25.85/hour
            expect(calculationsService.calculatePickerStatus(5, 1)).toBe('green');
        });
