      ...
      <div className="flex-1 overflow-y-auto px-4 pt-4 pb-28 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-border-light">
          <div className="flex items-start justify-between mb-2">
            ...
            <span className="px-2 py-1 rounded bg-green-50 text-green-700 text-[10px] font-black uppercase tracking-widest border border-green-100">
              Active
            </span>
          </div>
          {/* SVG Chart */}
          <div className="flex items-center justify-center py-4 relative">
            <div className="w-48 h-48 relative">
              <svg className="block mx-auto max-w-full h-auto" viewBox="0 0 36 36">
                <path
                  className="fill-none stroke-[#F1F1F1] stroke-[3]"
          ...
          <div className="text-center">
            <p className="text-text-main text-xl font-black">
              {activeBinBuckets}
              <span className="text-text-muted font-bold mx-1">/</span>
              {binCapacity}
            </p>
            <p className="text-xs font-bold text-text-muted uppercase tracking-wider mt-0.5">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-border-light flex items-center justify-between">
          ...
          <div className="text-right">
            <p className="text-2xl font-mono font-black text-text-main tabular-nums">
              {maxExposure}
            </p>
          </div>
        </div>
        ...
        {/* Supply Management */}
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-border-light">
          <h3 className="text-sm font-black text-text-main uppercase tracking-widest mb-4">
            Supply Management
          </h3>
          <div className="grid grid-cols-2 gap-4 mb-5">
            <div className="bg-slate-50 rounded-xl p-3 border border-border-light">
              ...
              <div className="flex items-baseline justify-between mt-1">
                ...
                <span
                  className={`text-[10px] font-black uppercase ${emptyBins < 5 ? 'text-primary' : 'text-success'}`}
                >
