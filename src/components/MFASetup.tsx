  ...
  return (
    <div className="mfa-setup max-w-lg mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="mb-6 text-center">
        <span className="material-symbols-outlined text-5xl mx-auto mb-3 text-blue-600">
          shield
        </span>
      ...
      {step === 'generate' && (
        <div className="text-center">
          <p className="mb-4 text-text-primary">Click below to generate your secure QR code</p>
          <button
        ...
        <div>
          <div className="mb-4">
            ...
            <p className="text-sm text-text-secondary mb-3">
              Open your authenticator app (Google Authenticator, Authy, Microsoft Authenticator) and
              scan this QR code:
            </p>
