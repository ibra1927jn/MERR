                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2.5 rounded-xl border text-sm font-medium outline-none transition-all ${errors.name ? 'border-red-300 focus:border-red-500 focus:ring-red-500/10' : 'border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10'
                                }`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2.5 rounded-xl border text-sm font-medium outline-none transition-all ${errors.plate ? 'border-red-300 focus:border-red-500 focus:ring-red-500/10' : 'border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10'
                                }`}
                        />
                        {errors.plate && <p className="text-xs text-red-600 mt-1">{errors.plate}</p>}
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-3 py-2.5 rounded-xl border text-sm font-medium outline-none transition-all ${errors.max_capacity ? 'border-red-300' : 'border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10'
                                    }`}
                            />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2.5 rounded-xl border text-sm font-medium outline-none transition-all ${errors.driver_name ? 'border-red-300' : 'border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10'
                                }`}
                        />
                        {errors.driver_name && <p className="text-xs text-red-600 mt-1">{errors.driver_name}</p>}
                    </div>
