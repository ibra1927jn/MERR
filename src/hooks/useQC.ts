...
export function useQC(): UseQCResult {
    ...
    const handleGrade = useCallback(async (grade: QualityGrade, photoBlob?: Blob | null) => {
    ...
    return {
        inspections, distribution, selectedPicker, notes,
        isSubmitting, isLoading, lastGrade, crew, orchardId,
        setSelectedPicker, setNotes, handleGrade, loadInspections,
    };
}
