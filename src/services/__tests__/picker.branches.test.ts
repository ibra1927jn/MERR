...
const mockQuery = vi.fn().mockResolvedValue([
    { id: 'p1', picker_id: 'P-001', name: 'Alice', status: 'active', safety_verified: true, current_row: 1, team_leader_id: 't1', orchard_id: 'o1' },
]);
...
describe('pickerService — deep branch tests', () => {
    ...
    describe('getPickersByTeam', () => {
        ...
        it('handles null picker name', async () => {
            mockQuery.mockResolvedValueOnce([
                { id: 'p1', picker_id: null, name: null, status: 'active', safety_verified: false, current_row: 0 },
            ]);
    ...
    describe('addPicker', () => {
        it('inserts picker with defaults', async () => {
            ...
            expect(mockInsert).toHaveBeenCalledWith(expect.objectContaining({
                name: 'New', picker_id: 'P-999', status: 'active',
            }));
        });
    });
    ...
    describe('updatePicker', () => {
        ...
        it('throws on duplicate picker_id', async () => {
            ...
            await expect(pickerService.updatePicker('p1', { picker_id: 'P-DUP' }))
