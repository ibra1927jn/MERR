...
vi.mock('@/repositories/optimisticLock.repository', () => ({
...
import type { OptimisticLockOptions, OptimisticLockResult } from './optimistic-lock.service';
...
describe('optimistic-lock.service — deep tests', () => {
    ...
    it('OptimisticLockOptions type is importable', () => {
        const opts: OptimisticLockOptions = {
            table: 'test', recordId: '1', expectedUpdatedAt: '2026-01-01', updates: {},
        };
