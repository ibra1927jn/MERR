...
vi.mock('@/repositories/user.repository', () => ({
    userRepository2: {
        getAll: vi.fn().mockResolvedValue([
            { id: 'u1', full_name: 'Alice', email: 'a@test.com', role: 'picker', status: 'active', created_at: '2026-01-01', orchard_id: 'o1' },
        ]),
    },
}));
...
import { fetchHRSummary, fetchEmployees, fetchContracts, createContract, fetchComplianceAlerts } from './hhrr.service';
