...
vi.mock('@/repositories/authContext.repository', () => ({
    authContextRepository: {
        getUserProfile: vi.fn().mockResolvedValue({
            data: {
                id: 'u1', email: 'farmer@nz.com', full_name: 'NZ Farmer',
...
describe('Auth Session Lifecycle — Integration', () => {
    ...
    it('signIn calls supabase.auth.signInWithPassword', async () => {
        ...
        await waitFor(() => {
            expect(mockSignInWithPassword).toHaveBeenCalledWith({
                email: 'farmer@nz.com', password: 'kiwi123',
            });
        });
    });
    ...
    it('signOut calls supabase.auth.signOut', async () => {
        ...
        await act(async () => { screen.getByTestId('sign-out-btn').click(); });
